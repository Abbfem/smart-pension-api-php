...
use SMART\Employee\Request\PatchRequest;
...
class Patch extends PatchRequest
{
     ...
     *
     * @param string $company_id Required. The ID of the company. Example: '649'.
     * @param string $id Required. The ID of the employee. Example: '394'.
     * @param PostData $postBody The employee details to update in JSON format with the following fields:
     *      - 'contribute_if_entitled' (boolean) Whether the employee contributes if entitled.
     ...
     *      - 'employee_contribution_configuration_starts_at' (string) Start date of employee contribution configuration.
     *
     */
