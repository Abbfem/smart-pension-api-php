...
use SMART\EmployeeConfiguration\Request\PutRequest;
...
class Update extends PutRequest
{
    ...
    *      - 'subject_to_money_purchase_annual_allowance' (boolean) Whether the employee is subject to the money purchase annual allowance.
    ...
    */
    ...
    {
        return "/employees/{$this->employee_id}/employee_configurations";
    }
