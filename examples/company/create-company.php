...
if (
    ...
    !isset($_GET['legal_structure']) ||
    !isset($_GET['signatories']) ||
    !isset($_GET['signatories_email']) ||
    !isset($_GET['signatories_forename']) ||
    !isset($_GET['signatories_surname']) ||
...
$postBody = new \SMART\VAT\SubmitVATReturnPostBody();
...
$request = new \SMART\VAT\SubmitVATReturnRequest($_GET['vrn'], $postBody);
